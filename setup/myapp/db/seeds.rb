...
User.create(nickname: 'theadmin',admin: true, email: 'admin@marvin.com', password_digest: "$2a$12$cy3.o43J2yid6vbkXojSAe0x2enBfAn4NcgVOQfXjdtPOV7tKF/1e", score: 5, matches_won: 1, matches_lost: 0, friends: [1, 2, 3, 5])
