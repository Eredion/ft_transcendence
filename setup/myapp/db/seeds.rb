...
User.create(nickname: 'marvin', email: 'marvin@marvin.com', score: 42, matches_won: 6, matches_lost: 1, friends: [2, 3, 4, 5], guild_id: 1, intournament: true, tournament_victories: 1, tournament_defeats: 2)
User.create(nickname: 'pabgonza', email: 'pabgonza@marvin.com', score: 27, matches_won: 3, matches_lost: 4, friends: [1, 3, 4, 5], guild_id: 1, intournament: true, tournament_victories: 3, tournament_defeats: 2)
User.create(nickname: 'apita-da', email: 'apita@marvin.com', score: 32, matches_won: 4, matches_lost: 2, friends: [1, 2, 4, 5], guild_id: 1, intournament: true, tournament_victories: 3, tournament_defeats: 0)
...
User.create(nickname: 'marvina', email: 'marvina@marvin.com', score: 24, matches_won: 3, matches_lost: 1, friends: [1, 2, 3, 4], guild_id: 1, intournament: true, tournament_victories: 3, tournament_defeats: 8)
