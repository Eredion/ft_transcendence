...
User.create(nickname: 'marvin', email: 'marvin@marvin.com', score: 420, matches_won: 6, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 1, friends: [2, 3, 4, 5], guild_id: 1)
User.create(nickname: 'pabgonza', email: 'pabgonza@marvin.com', score: 360, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_won: 3, matches_lost: 4, friends: [1, 3, 4, 5], guild_id: 3)
User.create(nickname: 'amalia', email: 'apita@marvin.com', score: 130, matches_won: 4, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 2, friends: [1, 2, 4, 5], guild_id: 2)
User.create(nickname: 'marvina', email: 'marvina@marvin.com', score: 1042, matches_won: 3, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 1, friends: [1, 2, 3, 4], guild_id: 3)
User.create(nickname: 'marvino', email: 'marvino@marvin.com', score: 900, matches_won: 3, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 4, friends: [7, 8], guild_id: 3)
User.create(nickname: 'marvinu', email: 'marvinu@marvin.com', score: 0, matches_won: 5, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 6, friends: [6, 8], guild_id: 2)
User.create(nickname: 'marvinx', email: 'marvinx@marvin.com', score: 0, matches_won: 8, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 2, friends: [6, 7])
User.create(nickname: 'marvinillo', email: 'marvinillo@marvin.com', score: 10, matches_won: 4, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 2)
User.create(nickname: 'marvinete', email: 'marvinete@marvin.com', score: 100, matches_won: 6, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 0, friends: [11])
User.create(nickname: 'marvinette', email: 'marvinette@marvin.com', score: 840, matches_won: 8, encrypted_password: "$2a$12$sIhkQS0Cd6UBHn.BIOoHTOeJ8C3KCqq4csE4N5H2LYJoXEwjEMpPq", matches_lost: 3, friends: [10])
