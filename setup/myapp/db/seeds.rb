...
User.create(nickname: 'theadmin', email: 'admin@marvin.com', score: 5, matches_won: 1, password_digest: "$2a$12$cy3.o43J2yid6vbkXojSAe0x2enBfAn4NcgVOQfXjdtPOV7tKF/1e", matches_lost: 0, friends: [1, 2, 3, 5], guild_id: 1,)
